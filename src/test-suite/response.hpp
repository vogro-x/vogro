...
void TestFailedReportor(const std::string method, const std::string path,
    ...
    std::cout << "[" << method << "] " << path << INITCOLOR(RED_COLOR) << " Failed" << INITCOLOR(ZERO_COLOR)
              << std::endl << std::endl;
...
namespace vogro {
    ...
    public:
        HeaderExpectation(const std::map <std::string, std::string> &hdrs, const std::string &method,
                          const std::string &path)
                : headers(hdrs), method_(method), path_(path) {
        }
    ...
    public:
        BodyExpectation(const std::string &bd, const std::string &method, const std::string &path)
                : body(bd), method_(method), path_(path) {
        }
    ...
    public:
        ...
        Response(const std::string &bd, std::map <std::string, std::string> &hdrs, const std::string &req_method,
                 const std::string &req_path)
                : req_method_(req_method), req_path_(req_path), headers(hdrs), body(bd) {
        }
