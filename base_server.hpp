...
#include "logger/policy.hpp"
#include "logger/logger.hpp"

namespace vogro_logger_ns= vogro::logger;


namespace vogro {

typedef std::map<std::string, std::unordered_map<std::string,
std::function<void(vogro::Response&, vogro::Request&)>>> RegistrationCenter;
    ...
    public:
                    ...
                    *request = parse_request(stream);
                    ...
                    if(request->getHeader("Content-Length")!="") {
                        ...
                        if(!ec) {
                                ...
                                request->setContent(std::shared_ptr<std::istream>(new std::istream(read_buffer.get())));
        ...
        void respond(std::shared_ptr<socket_type> socket, std::shared_ptr<vogro::Request> request) const {
            ...
            for(auto res_it: all_resources) {
                ...
                // std::cout<<"not found handler for requested url"<<std::endl;
        ...
        void customErrorHandler(unsigned long code,std::function<void(vogro::Response&, vogro::Request&)> handler) {
